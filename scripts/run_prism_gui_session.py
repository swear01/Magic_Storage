...
SCENARIOS = {
    ...
    "crafting-fuel-page": {
        ...
        "checks": [
            "Pass the fullscreen gate before pressing hotbar/use/click/scroll.",
            "Use hotbar `8` and confirm the prepared world is at the true-void ready baseline: one active network backed by a fresh empty Core record, six connected Storage Unit tiers, empty timed-station slots and instant-station slots, zero Axe Energy, and zero timed/Fuel reserves.",
