...
## Task 1: Lock public station-variant contracts
...
## Task 2: Add exact fractional Core generation
...
## Task 3: Add station-work recipe cost
...
## Task 4: Add preview variant cycling
...
## Task 5: Integrate Iron Furnaces
...
## Task 6: Add the bounded multi-item family API
...
## Task 7: Integrate Farmer's Delight
...
## Task 8: Integrate Mekanism recipes
...
3. Use typed plans for Reaction's fluid/chemical/FE inputs and optional chemical output; reject chemical-only output and unsupported per-tick semantics.
4. Re-run all Mekanism chemical capability and recipe tests.

## Task 9: Finish docs and gates
