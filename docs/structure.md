...
| Path | Purpose |
|------|---------|
| `src/main/java/com/swearprom/magicstorage/magic_storage/` | 全部 Java 原始碼(~36 檔,單一扁平 package):方塊、BlockEntity、GUI Screen、封包、能量表、`MagicStorage.java` 註冊入口。 |
| `src/main/resources/assets/magic_storage/` | 客戶端資源(模型、材質、lang、blockstates)。 |
