...
- GitHub public repo / CI/CD:新增 public repo https://github.com/swear01/Magic_Storage；CI 在 push/PR/manual 跑 JDK 21 build、GameTest、Python unittest 並上傳 jar artifact；CD 在 tag `v<mod_version>` 時驗版本、重跑測試並建立 GitHub Release。
